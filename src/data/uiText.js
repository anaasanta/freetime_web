...
export const profileCopy = {
  ...
  planned: {
    ...
    notificationPlaceholder: 'Selecciona una notificacio',
    notificationOptions: [
      { id: '30-min', label: '30 minuts abans' },
      { id: '1-hour', label: '1 hora abans' },
      { id: '1-day', label: '1 dia abans' },
      { id: 'none', label: 'No rebre notificacio' },
    ],
    duration: 'Durada',
    minutes: 'minuts',
    filters: {
